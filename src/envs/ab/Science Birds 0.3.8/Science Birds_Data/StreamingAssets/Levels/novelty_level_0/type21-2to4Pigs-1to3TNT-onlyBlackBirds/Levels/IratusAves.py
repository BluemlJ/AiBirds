...
minimum_number_pigs = 2
maximum_number_pigs = 4
...
# Value will be reduced automatically if there is not enough space in the level
minimum_number_platform_structures = 1
maximum_number_platform_structures = 3        
